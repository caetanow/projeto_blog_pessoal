...
public class Postagem {
    ...
    @NotBlank(message = "O atribuno título é obrigatório e não pode ser vazio.")
    ...
    @Size(min = 10, max = 1000, message = "O atributo texto deve conter no mínimo 10 caracteres e no máximo 100 caracteres.")
